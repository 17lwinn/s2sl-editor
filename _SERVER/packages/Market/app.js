...
async function view(app) {
  ...
  document.getElementById(`${package.name}infobanner`).src = `https://media.discordapp.net/attachments/605344668330491925/676956851312525312/unknown.png?width=1080&height=114`;
