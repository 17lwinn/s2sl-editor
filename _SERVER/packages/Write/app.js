...
await document.getElementById(document.getElementById(`${package.name}Text`)).src = `data:text/html;base64,${btoa('<head><link href="https://fonts.googleapis.com/css?family=Open+Sans" rel="stylesheet"></head><body contenteditable></body>')}`;
